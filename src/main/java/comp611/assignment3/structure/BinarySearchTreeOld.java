...
public class BinarySearchTreeOld<E> extends AbstractSet<E> implements SortedSet<E> {
    ...
    public BinarySearchTreeOld(Collection<? extends E> c) {
        this();
        for (E element : c)
            add(element);
    }

    public BinarySearchTreeOld(Comparator<? super E> comparator) {
        this();
        this.comparator = comparator;
    }

    public BinarySearchTreeOld(SortedSet<E> s) {
        this();
    ...
    private BinarySearchTreeOld(BinaryTreeNode rootNode, Comparator<? super E> comparator, E fromElement, E toElement) {
        this(comparator);
    ...
    public SortedSet<E> subSet(E fromElement, E toElement) {
        return new BinarySearchTreeOld<E>(rootNode, comparator, fromElement,
                toElement);
    }
    ...
    public static void main(String[] args) {  // create the binary search tree
        SortedSet<String> tree = new BinarySearchTreeOld<String>();
        // build the tree
        tree.add("cow");
        tree.add("fly");
        tree.add("dog");
